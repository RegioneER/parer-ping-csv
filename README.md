...
- SACER PING File azioni pagine.csv: lista delle **azioni** a cui l'operatore viene abilitato all'interno della singola pagina; 
- SACER PING File entrate menu.csv: voci del **menù** a cui fanno riferimento la macro-funzionalità;
- SACER PING File pagine web.csv: lista delle **pagine** a cui l'operatore viene abilitato;
- SACER PING File servizi web.csv: lista dei **servizi** (REST/SOAP) codificati per cui è possibile abilitare un specifico utente.
...
## SACER PING File azioni pagine.csv

Il file riporta i seguenti attributi / colonne da compilare opportutamente: 

- "APPLIC": nome applicazione, nel caso specifico riportare **PING**;
...
|"SACER_PREINGEST"|"/amministrazione/ambienteVersDetail"|"button/AmministrazioneForm#ParametriAmbienteButtonList/parametriAmministrazioneAmbienteButton"|"Carica pagina parametri amministrazione"|

## SACER PING File entrate menu.csv
...
|"SACER_PREINGEST"|"Menu.AmministrazioneTrasformazioni"|"Amministrazione delle trasformazioni"|2;7|"Menu"|""|


## SACER PING File pagine web.csv
...
## SACER PING File servizi web.csv
